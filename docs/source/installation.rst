...
After downloading the `latest distribution <https://github.com/sebastianbernasek/flyqma/archive/v0.1-beta.tar.gz>`_, the simplest method is to install via ``pip``:
